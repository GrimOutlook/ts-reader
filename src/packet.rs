...
mod tests {
    ...
    fn packet_1() -> (Box<[u8]>, AdaptationFieldControl, Box<[u8]>) {
        let packet = [
            
        ];
    ...
    fn packet_2() -> (Box<[u8]>, AdaptationFieldControl, Box<[u8]>) {
        let packet = [
            
        ];
    ...
    #[test_case(packet_2)]
    #[test_case(packet_1)]
    fn from_bytes(p: fn() -> (Box<[u8]>, AdaptationFieldControl, Box<[u8]>)) {
        let (mut buf, adaptation_field_control, first_packet_bytes) = p();
